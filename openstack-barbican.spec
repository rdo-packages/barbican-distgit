...
%changelog
* Mon May 15 2023 Grzegorz Grasza <xek@redhat.com> 13.0.2-2
- Fix barbican config files permissions

* Thu Dec 01 2022 RDO <dev@lists.rdoproject.org> 13.0.2-1
- Update to 13.0.2
...
* Thu Oct 06 2022 RDO <dev@lists.rdoproject.org> 13.0.1-1
- Update to 13.0.1
