...
%changelog
* Mon May 15 2023 Grzegorz Grasza <xek@redhat.com> 12.0.2-2
- Fix barbican config files permissions

* Mon Oct 24 2022 RDO <dev@lists.rdoproject.org> 12.0.2-1
- Update to 12.0.2

* Tue Oct 18 2022 Joel Capitao <jcapitao@redhat.com> 12.0.1-3
- Fix typo in keystone-listener service

* Thu Oct 13 2022 Joel Capitao <jcapitao@redhat.com> 12.0.1-2
- Make sure common and python lib dependencies is upgraded

* Thu Aug 18 2022 RDO <dev@lists.rdoproject.org> 12.0.1-1
- Update to 12.0.1

* Wed Apr 14 2021 RDO <dev@lists.rdoproject.org> 12.0.0-1
- Update to 12.0.0

* Mon Apr 05 2021 RDO <dev@lists.rdoproject.org> 12.0.0-0.2.0rc1
